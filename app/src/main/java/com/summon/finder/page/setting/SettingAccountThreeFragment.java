...
public class SettingAccountThreeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_config_user_step_three, container, false);
    ...
    public void onStart() {
        ...
        if (settingAccountActivity.userModel.getGender().equals("")) {
            offModeClick(button);
        }
    }
    ...
    private void addStyleInit() {
        for (int i = 0; i < allButton.size(); i++) {
            ...
            if (settingAccountActivity.userModel.getGender().contains(s)) {
                addStyle(button);
            }
        }
    }
