...
public class SettingAccountFiveFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_config_user_step_five, container, false);

        settingAccountActivity = (SettingAccountActivity) getActivity();

        button = view.findViewById(R.id.asa_continue);
        editText = view.findViewById(R.id.textPersonSchool);
    ...
    public void onStart() {
        super.onStart();
        setSchoolToView();
        if (settingAccountActivity.userModel.getSchool().equals("")) {
            offModeClick(button);
        }
    }
    ...
    private void setSchoolToView() {
        ...
        editText.setText(settingAccountActivity.userModel.getSchool());
    }
